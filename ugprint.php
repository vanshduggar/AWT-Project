		...
		<div class="row">
			<div class="col student-information">
				...
				<tr>
					...
					<td rowspan="3" >
					<span><img src="upload/<?php echo $row[61]; ?>" alt="" width="80" height="80"> </span><br><br>
							<span><img src="upload/<?php echo $row[62]; ?>" alt="" width="80" height="40"></span>
			...
			<table id="sub-table-1">
					<tr>
						 <td colspan="5">
							 10. Particular of the H.S.C. Examination :
						 </td>
					</tr>
					<tr>
						<td colspan="1">
							a). Have you passed Exam from State Board? :  
							<span>
							<?php echo $row[20]; ?>
							</span>
						</td>
						<td colspan="4">
							If No then Specify name of Board : 
							<span>
							<?php 
							 if($row[22]!="")
							 {
					...
					<tr>
						<td colspan='5'>
							b). Name of the School / Jr. College / College : 
								<span>
								<?php echo $row[23]; ?>
								</span>
						</td>
			...
			<table id="sub-table-2">
				...
				<tr>
					...
					<td><span><?php echo $row[28]; ?></span></td>
					<td><span><?php echo $row[29]; ?></span></td>
					<td><span><?php echo $row[29]; ?></span></td>
					<td><span><?php echo $row[32]; ?></span></td>
					<td><span><?php echo $row[33]; ?></span></td>
				</tr>
			...
			<table id="table">
					<tr>
						<td colspan="1">
							12. Email-ID : <span><?php echo $row[34]; ?></span>
						</td>
						<td colspan="4">
							13. Mobile no. : <span><?php echo $row[35]; ?></span>
						</td>
					</tr>
			</table>
			<table id="sub-table-1">
				<span>14.</span>
					<tr>
						<td colspan="2">
							Permanent Address: <span><?php echo $row[36]; ?></span>
						</td>
					</tr>
					<tr>
						<td>
							Tahsil : <span><?php echo $row[37]; ?></span>
						</td>
						<td>
							District: <span><?php echo $row[38]; ?></span>
						</td>
					</tr>
					<tr>
						<td>
							State: <span><?php echo $row[39]; ?></span>
						</td>
						<td>
							Pin Code: <span><?php echo $row[40]; ?></span>
						</td>
					</tr>
			</table>
			<div>
				15. Please Specify Education Gap details if any
				<span><?php echo $row[41]; ?></span>
		<table id="sub-table-2">
			<tr>
				<th>Last Exam</th>
				<th>Exam Seat no</th>
			...
			<div>
				16. Are you belongs to minority ? <span><?php  echo $row[48]; ?></span>
...
<div class="col-4 college-logo"><img src="img/logo.png" alt="logo.png" style="height: 300px;width:1000px;">
	...
	<table border="1" align="center" cellspacing="0" cellpadding="10">
        ...
        <tr>
            ...
            <td align="center">
                Student Signature: <span><img src="upload/sign.jpg" alt="" width="80" height="40"></span>
            </td>
